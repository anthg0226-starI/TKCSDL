...
\begin{itemize}[leftmargin=2em]
    \item \textbf{Đối tượng khảo sát:} Bao gồm hạ tầng phần cứng (\texttt{Site}, \texttt{Room}, \texttt{Rack}, \texttt{Server}) và các nhóm người dùng tương tác với hệ thống (\texttt{Administrator}, \texttt{Operator}, \texttt{FieldTechnician}).
    \item \textbf{Dữ liệu vận hành:} Tập trung vào các chỉ số thời gian thực như CPU, RAM, thông lượng mạng và trạng thái của các khối lượng công việc (\texttt{Workload}).
