...
Nhằm giúp quản trị viên nhanh chóng lọc ra các cảnh báo nguy hiểm chưa được xử lý, hệ thống áp dụng các chỉ mục trên bảng \texttt{Alert}, \texttt{Incident} và \texttt{MaintenanceTicket}:
...
CREATE NONCLUSTERED INDEX IX_Maintenance_Status ON MaintenanceTicket(Status);
\end{verbatim}
