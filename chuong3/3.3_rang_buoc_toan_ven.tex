...
\subsection{Ràng buộc Toàn vẹn Dữ liệu}
 ...
 Trình bày chi tiết các ràng buộc toàn vẹn (Integrity Constraints) được áp dụng trên toàn bộ lược đồ cơ sở dữ liệu của hệ thống AR-IMMS, nhằm đảm bảo tính nhất quán, chính xác và hợp lệ của dữ liệu trong suốt vòng đời vận hành. Các ràng buộc được phân loại thành 5 nhóm chính.
