...
Hệ thống bao gồm 23 mối quan hệ chính giữa các thực thể, đảm bảo tính toàn vẹn dữ liệu từ hạ tầng vật lý đến các tác vụ vận hành thực địa:

\begin{longtable}{|c|l|c|l|p{6cm}|}
\caption{Bảng tổng hợp các mối quan hệ trong sơ đồ ERD} \label{tab:erd_relationships} \\
\hline
\textbf{STT} & \textbf{Thực thể A} & \textbf{Quan hệ (A : B)} & \textbf{Thực thể B} & \textbf{Ý nghĩa nghiệp vụ} \\ \hline
\endfirsthead

\multicolumn{5}{c}{{\tablename\ \thetable{} -- Tiếp theo từ trang trước}} \\
\hline
\textbf{STT} & \textbf{Thực thể A} & \textbf{Quan hệ (A : B)} & \textbf{Thực thể B} & \textbf{Ý nghĩa nghiệp vụ} \\ \hline
\endhead

\hline \multicolumn{5}{r}{{Xem tiếp trang sau}} \\
\endfoot
